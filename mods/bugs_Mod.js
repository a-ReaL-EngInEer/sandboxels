...
elements._ = {
	color: "#ffffff",
	excludeRandom: false,
	behavior: [["XX","XX","XX"],["XX","DE:_","XX"],["XX","XX","XX"]],
	category: "states",
	state: "gas",
},
...
elements.weather = {
	color: "#7A9CE1",
	excludeRandom: false,
	behavior: [["M1","M2 AND CR:flash,electric,water%0.05 AND CR:cloud,rain_cloud,snow_cloud,steam%0.07 AND CR:thunder_cloud,hail_cloud,tornado%0.03","M1"],["M2","XX","M2"],["M1","M2","M1"]],
	category: "ecosystem",
	state: "gas",
},
...
elements.leaf_litter = {
	color: ["#684841","#3D5B07","#2d4814","#006300","#584011","#7a640f"],
	excludeRandom: false,
	behavior: [["XX","XX","XX"],["SP%20","CH:dirt%0.03","SP%20"],["M1","M2","M1"]],
	category: "ecosystem",
	state: "solid",
	reactions: {
		"water": { elem1: "dirt", elem2: "mud", chance:0.1}, 
	}
},
...
elements.green_spored_parasol_stalk = {
	...
	color: "#897B5E",
	excludeRandom: false,
	behavior: [["XX","SP","XX"],["XX","XX","XX"],["XX","M1 AND CH:dirt,leaf_litter,mud,moss,water,dirty_water,poison>hyphae%1 AND SP","XX"]],
	category: "ecosystem",
	state: "solid",
    breakInto:"mycelium",
    reactions: {
...
elements.green_spored_parasol_cap = {
	...
	color: ["#D3CCBF","#BA9F8A"],
	excludeRandom: false,
    breakInto:"green_spored_parasol",
...
elements.fungi = {
	color: "#FFFFFF",
	excludeRandom: false,
	behavior: [["XX","XX","XX"],["XX","CH:mushroom_spore,conecap_mushroom_spore,green_spored_parasol_spore,meadow_mushroom_spore,meadow_mushroom_spore,meadow_mushroom_spore,giant_puffball_mushroom_spore,amanita_muscaria_spore","XX"],["XX","XX","XX"]],
	category: "ecosystem",
	cooldown: defaultCooldown,
	state: "solid",
