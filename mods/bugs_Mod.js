...
elements.hyphae.behavior = [["CH:dirt>hyphae,hyphae,mycelium%0.05","CR:conecap_mushroom_spore,conecap_mushroom_spore,green_spored_parasol_spore,green_spored_parasol_spore,mushroom_spore%0.5,","CH:dirt>hyphae,hyphae,mycelium%0.05"], ["CH:dirt>hyphae,hyphae,mycelium%0.05","CH:dirt%0.1","CH:dirt>hyphae,hyphae,mycelium%0.05"], ["CH:dirt>hyphae,hyphae,mycelium%0.05","CH:dirt>hyphae,hyphae,mycelium%0.05","CH:dirt>hyphae,hyphae,mycelium%0.05"]];
...
elements.green_spored_parasol_spore = {
	...
	color: "#59605A",
	excludeRandom: false,
	behavior: [["XX","M2%1.5","XX"],["XX","L2:green_spored_parasol_stalk,green_spored_parasol_ring AND C2:green_spored_parasol_gill%80","XX"],["M1","M1","M1"]],
	category: "ecosystem",
	state: "solid",
},
...
elements.green_spored_parasol_gill = {
	...
	excludeRandom: false,
	behavior: [["XX","CR:green_spored_parasol_cap%5 AND CR:green_spored_parasol_gill%1","XX"],["SA AND CR:green_spored_parasol_gill%1","XX","SA AND CR:green_spored_parasol_gill%1"],["CR:dirty_water%0.05","M1 AND SP","CR:dirty_water%0.05"]],
	category: "ecosystem",
	state: "solid",
},
...
elements.infested_meat = {
	...
	excludeRandom: false,
    behavior: [["XX","SP AND CR:mushroom_spore,mushroom_gill,mold,mold,mold,mushroom_spore%0.0175 AND CR:male_green_bottle_fly,green_bottle_fly_larva,green_bottle_fly_pupa%0.0047","XX"],["SP","CH:mushroom_spore,green_bottle_fly_larva,green_bottle_fly_egg%0.01","SP"],["XX","M1","XX"]],
	category: "ecosystem",
	state: "solid",
	reactions: {
...
elements.fungi = {
	color: "#FFFFFF",
	excludeRandom: false,
	behavior: [["XX","XX","XX"],["XX","CH:mushroom_spore,conecap_mushroom_spore,green_spored_parasol_spore","XX"],["XX","XX","XX"]],
	category: "ecosystem",
	state: "solid",
